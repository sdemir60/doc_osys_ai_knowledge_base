...
Bu proje OSYS mimari yapısını takip eder. **Her soru veya kod önerisi için öncelikle workspace'teki `doc_osys_ai_knowledge_base` klasöründeki tüm dokümantasyonları kullan.**
