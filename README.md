...
Her OSYS workspace'inde `.cursor/rules/PROJECT_RULES.md` dosyası oluşturup `.cursor-osys/cursor-project-rules.md`'ye referans verin. Detaylar için `.cursor-osys/README.md` dosyasına bakın.
